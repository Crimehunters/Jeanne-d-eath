...
var speed
export var default_boss_hp = 120
var hp
...
# Knight: 
# 	Armor Up: High linear_bar, self HP priority
# 	Judgment Cut: Low linear_bar, Ply HP priority
#	Dash: Low linear_bar, directional priority
# 
##### For AI ######
...
func apply_ability(delta):
	if(skill_cd > 0): skill_cd -= delta
		...
		if(ai_state == ai_states.OFFENCE): SkillPool.use(10, "Boss")
		elif(ai_state == ai_states.DEFFENCE): SkillPool.use(6, "Boss")
		skill_cd = 8
